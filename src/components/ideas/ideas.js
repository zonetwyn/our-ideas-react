...
class Ideas extends Component {
    ...
    refresh = () => {
        ...
        axios.get(Api.ideas, configs).then(response => {
    ...
    handleStateChanged = (id, status) => {
        axios.patch(Api.ideas + '/' + id + '/status', { status }, config).then(() => {
            this.refresh();
        }).catch(error => {
                                        ...
                                        return (
                                            <Table.Row key={doc._id}>
                                                ...
                                                <Table.Cell>
                                                    ...
                                                    {
                                                        doc.status === 'rejected' ? (
                                                            <Button icon size='tiny' onClick={() => {this.handleStateChanged(doc._id, 'authorized')}}>
                                                                <Icon name='check' />
                                                            </Button>
                                                        ) : (
